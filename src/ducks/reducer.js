...
const GET_MATCHING_ACTIVITY_LOCATIONS = "GET_USER_ACTIVITY"
const GET_SPECIFIC_ACTIVITY_LOCATION = "GET_SPECIFIC_ACTIVITY"
const DESCRIBE_ACTIVITY = "DESCRIBE_ACTIVITY"
const ACTIVITY_PHOTO_REFERENCE_ID = "PHOTO_REFERENCE_ID"


//food constants
const INPUT_FOOD = "INPUT_FOOD"
const GET_MATCHING_FOOD_LOCATIONS = "GET_USER_ACTIVITY"
const GET_SPECIFIC_FOOD_LOCATION = "GET_SPECIFIC_ACTIVITY"
const DESCRIBE_FOOD = "DESCRIBE_FOOD"
const FOOD_PHOTO_REFERENCE_ID = "PHOTO_REFERENCE_ID"

//memory locations
const INPUT_MEMORY = "INPUT_FOOD"
const GET_MATCHING_MEMORY_LOCATIONS = "GET_USER_ACTIVITY"
const GET_SPECIFIC_MEMORY_LOCATION = "GET_SPECIFIC_ACTIVITY"
const DESCRIBE_MEMORY = "DESCRIBE_FOOD"
const MEMORY_PHOTO_REFERENCE_ID = "PHOTO_REFERENCE_ID"
...
export default function reducer(state = initialState, action) {
  ...
  switch (action.type) {
    ...
    case `${GET_MATCHING_ACTIVITY_LOCATIONS}_FULFILLED`:
       return {
         ...state, allMatchingActivityLocations: action.payload.data
       }
  ...
  case `${GET_MATCHING_FOOD_LOCATIONS}_FULFILLED`:
     return {
       ...state, allMatchingFoodLocations: action.payload.data
     }
...
export function getSpecifiActivity(specific) {
...
export function activityPhotoReference(photo) {
  ...
  return {
    ...
    payload: axios.post(`https://maps.googleapis.com/maps/api/geocode/json?key=${
        process.env.REACT_APP_GOOGLE
      }&address=${photo}`)
  };
}
